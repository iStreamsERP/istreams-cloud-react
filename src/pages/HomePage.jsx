  ...
  return (
    <div className="flex flex-col gap-y-4">
      ...
      <div className="grid gap-2 grid-cols-1 lg:grid-cols-2 mt-3 w-full">
        {/* Tasks Table */}
        <div className="overflow-y-scroll w-full h-[420px] shadow-lg hover:shadow-xl rounded-lg whitespace-nowrap border p-3 pb-2 border-blue-100/50 bg-white dark:bg-transparent hover:bg-slate-50 dark:hover:bg-slate-800 transition-shadow duration-300">
